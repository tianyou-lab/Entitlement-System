...
describe('LicenseApiClient', () => {
  it('returns data for OK response', async () => {
    ...
    const client = new LicenseApiClient('http://localhost:3000', 'demo', '1.0.0', fetchImpl as any);
  ...
  it('adds request signature headers when configured', async () => {
    ...
    const client = new LicenseApiClient('http://localhost:3000', 'demo', '1.0.0', fetchImpl as any, 'secret');
